...
func TestAccProgramResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccProgramResourceConfig("one"),
			...
			{
				Config: testAccProgramResourceConfig("two"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccProgramResourceConfig(configurableAttribute string) string {
	return fmt.Sprintf(`
